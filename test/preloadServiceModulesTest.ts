...
describe('preloadServiceModules', () => {
    it('loads services for given files pattern', () => {
        ...
        expect(container.findByName('Test1_Service1'))
            .toBeInstanceOf(Definition);
        expect(container.findByName('Test1_Service2'))
            .toBeInstanceOf(Definition);
        expect(container.findByName('ExcludedService'))
            .toBeUndefined();
    });
    ...
    it('multiple patterns', () => {
        ...
        expect(container.findByName('Test2_Service1'))
            .toBeInstanceOf(Definition);
        expect(container.findByName('Test2_Service2'))
            .toBeInstanceOf(Definition);
        expect(container.findByName('ExcludedService'))
            .toBeUndefined();
    })
